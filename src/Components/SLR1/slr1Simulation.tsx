...
import { CheckCircle, ChevronLeft, ChevronRight, ClipboardList, Layers, Play, RefreshCw, TextCursorInput, Type, XCircle, Zap } from 'lucide-react';
...
export function SLR1Simulation({ steps, accepted, error }: Props) {
  ...
  return (
    <div className="space-y-4 text-gray-400">
        ...
        <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
          ...
          <div className="flex flex-wrap gap-2">
            {step.stack.map((state, idx) => (
              <span key={idx} className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-lg font-mono text-sm">
                {state}
              </span>
            ))}
          </div>
      ...
      {/* Tabla de todos los pasos (opcional, colapsable) */}
