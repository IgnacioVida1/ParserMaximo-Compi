import type { SLR1Action } from '../../Parsers/slr1';

interface Props {
    actionTable: Map<number, Map<string, SLR1Action>>;
...
export function SLR1TablesView({ actionTable, gotoTable, terminals, nonTerminals, numStates }: Props) {
