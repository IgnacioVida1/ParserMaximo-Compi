import type { LR1Action } from '../../Parsers/lr1/lr1';

interface Props {
  actionTable: Map<number, Map<string, LR1Action>>;
...
export function LR1TablesView({ actionTable, gotoTable, terminals, nonTerminals, numStates }: Props) {
