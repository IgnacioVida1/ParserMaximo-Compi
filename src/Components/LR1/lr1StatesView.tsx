import type { LR1Item } from '../../Parsers/lr1/lr1Items';
...
export function LR1StatesView({ states, itemSet }: Props) {
  ...
  return (
    <div className="space-y-4 text-gray-400 ">
      ...
      <div className="bg-slate-900 rounded-lg p-4 border border-slate-700">
        <h3 className="text-lg font-semibold text-purple-400 mb-3">Estado I{validStateIndex}</h3>
